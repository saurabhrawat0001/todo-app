    ...
    <div className='flex h-screen justify-center items-center bg-gray-100'>
      ...
      <form onSubmit={handleRegister}>
        <div className='mb-4'>
          ...
          <input value={username} onChange={(e)=>setUserName(e.target.value)} className='w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500' type="text" placeholder='Enter your username'/>
        </div>
